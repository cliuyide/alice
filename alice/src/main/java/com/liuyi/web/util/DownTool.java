...
public class DownTool {
    ...
    private String getFileNameByUrl(String url, String contentType) {
        // 移除 "http://" 这七个字符
        url = url.substring(7); // 确认抓取到的页面为 text/html 类型
    ...
    public String downloadFile(String url) {
        ...
        getMethod.setRequestHeader(HttpMethodParams.HTTP_CONTENT_CHARSET, "GB2312");
        // 3.执行GET请求
        try {
            ...
            filePath = "D:/getUrlHtml/" + getFileNameByUrl(url,
